...
path_output_images = "Extracted_Features/vit_features"
path_output_references = "Extracted_Features/vit_references_features"
...
#build dino model
print("Building ViT model from pre-trained weights")
